        ...
        try:
                ...
                while file:
                        ...
                        if 'access_token' in mpsh:
                                ...
                                back +=1
                                sys.stdout.write('\r\r'+b+'[+]'+w+' Cracking ('+p+str(back)+w+'/'+p+str(len(up))+w+') live ('+g+str(len(berhasil))+w+') check ('+y+str(len(cekpoint))+w+') failed ('+r+str(len(gagal))+w+')');sys.stdout.flush()
        except IOError:
