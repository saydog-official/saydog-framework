...
def inject():
    try:
        ...
        pkgname = os.popen('''aapt dump badging '''+a2+''' | awk '/package/{gsub("name=|'"'"'","");'''+"""  print $2}'""").readline().rstrip()
        pkgactivity = os.popen('''aapt dump badging '''+a2+''' | awk '/activity/{gsub("name=|'"'"'","");'''+"""  print $2}'""").readline().rstrip()
